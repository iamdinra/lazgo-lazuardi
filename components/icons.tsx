...
export const InsightIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12 2C9.24 2 7 4.24 7 7c0 2.26 1.34 4.2 3.25 5.12V14h-1.5c-.83 0-1.5.67-1.5 1.5v.5h6v-.5c0-.83-.67-1.5-1.5-1.5H13v-1.88C14.91 11.2 16.25 9.26 16.25 7c0-2.76-2.24-5-5.25-5zM9 7c0-1.65 1.35-3 3-3s3 1.35 3 3-1.35 3-3 3-3-1.35-3-3zM12 22c-2.21 0-4-1.79-4-4h8c0 2.21-1.79 4-4 4z"/>
    </svg>
);

export const ClassIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export const PieChartIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L11 13v6.93zM13 4.07c.83.3 1.6.77 2.28 1.36L13 7.71V4.07zM15.28 6.43A8.002 8.002 0 0 1 19.93 11H13.29l2-4.57z"/>
    </svg>
);
